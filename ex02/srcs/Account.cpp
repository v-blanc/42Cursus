...
/*   Updated: 2025/04/29 12:29:55 by vblanc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Account::displayAccountsInfos(void)
{
	...
	cout << ";deposits:" << getNbDeposits() << ";withdrawals:" << getNbWithdrawals() << endl;
}
...
void Account::makeDeposit(int deposit)
{
	...
	cout << ";deposit:" << deposit << ";amount:" << this->_amount + deposit;
...
{
	Account::_displayTimestamp();
	cout << "index:" << this->_accountIndex << ";amout:" << checkAmount();
...
void Account::_displayTimestamp(void)
{
	...
	cout << "_" << ltm->tm_hour << ltm->tm_min << ltm->tm_sec << "] ";
}
